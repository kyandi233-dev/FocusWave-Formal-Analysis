...
**2026-09-25 跨仓库状态核对**：毫米波 HR/BR 已获正式 Q1 预测及设备组合比较资格，生理效度仍为 `LIMITED_SUPPORTING_ONLY`，HRV 为 `BLOCKED`；预测资格不等于生理验证。8 月 31 日 GitHub DOCX、本地国赛提交文件和当前 Markdown 的身份见[报告成品状态](国赛报告/README.md)，核对依据和未解决项见[跨仓库收口记录](运行记录与证据/09-25-3-跨仓库心肺资格与报告成品状态收口.md)。
