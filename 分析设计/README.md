...
**2026-09-10补充：当前主线采用Q1监督学习，二分类为1对2/3/4，Q2先用于解释。均值与中位数恢复为待评估候选；共同有效样本、含缺失分析、遗漏别名及预测导出修订见[1.15-监督学习补充决策与共同样本区分](1.15-监督学习补充决策与共同样本区分_20260910.md)。以下共同状态文档保留此前讨论，冲突处以1.15的新决定为准。**
