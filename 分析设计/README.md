...
2026-09-25 两项冻结后补充分析已经收口：[`1.16.29` 行为 20 秒与 30 秒同样本配对验证](1.16.29-行为20秒与30秒同样本配对验证_20260925.md)未发现明确差异，30 秒主窗口维持；[`1.16.28` 预定义精简模型嵌套验证](1.16.28-预定义精简模型嵌套LOSO验证_20260925.md)未显示优于冻结完整模型，正式基准维持。两项均不重开当前样本的窗口或特征子集搜索。
