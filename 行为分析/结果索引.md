...
## 监督学习窗口补充验证（2026-09-25）

20 秒与 30 秒窗口的同样本配对重训使用 61 名参与者、116 场、2,306 个共同探针。Δ对数损失（30 秒 − 20 秒）为 −0.007751，95% 置信区间 [−0.015151, 0.002301]，独立核验 `PASS`；30 秒正式主窗口不变。方法与运行证据分别见 [`1.16.29`](../分析设计/1.16.29-行为20秒与30秒同样本配对验证_20260925.md) 和 [`09-25-2`](../运行记录与证据/09-25-2-行为20秒30秒同样本配对验证.md)。
