...
> **版本状态（2026-09-12）**：本目录现作为此前报告版本的历史正文草稿区保留，用于 provenance（来源追踪）、旧结果核对与版本比较。基于 1.16 系列重新组织的新报告正文统一写入 [`../新版章节草稿_20260912/`](../新版章节草稿_20260912/)。后续不得再以覆盖方式把新版章节写回本目录。
...
本目录保留按 `0827报告v1.docx` 既有结构形成的逐章融合稿。题目、摘要和关键词不编号，正文从“1 引言”开始。自 2026-09-12 起，本目录不再承担 1.16 新版报告的唯一正文入口。
