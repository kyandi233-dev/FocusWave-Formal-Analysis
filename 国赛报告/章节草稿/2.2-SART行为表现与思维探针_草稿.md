...
在行为记录与即时主观报告的联合测量中，持续性注意反应任务（Sustained Attention to Response Task，SART）提供连续的任务执行信息，思维探针则在特定时点采样近期意识内容或主观清醒程度。二者分别回答参与者“怎样完成任务”和“当时如何体验自身状态”，从而使任务表现与主观体验能够在时间上相互参照。
