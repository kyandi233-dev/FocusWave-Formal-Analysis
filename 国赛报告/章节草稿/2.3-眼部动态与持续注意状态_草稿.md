...
眨眼提供了与瞳孔不同的眼部行为信息。自发眨眼承担眼表保护功能，同时受到视觉加工需求、任务组织、疲劳和困倦等状态调节。在视觉警觉任务中，Maffei 和 Angrilli（2018）发现更高的注意负荷伴随更低的眨眼频率，而随任务持续，眨眼频率又出现上升；在听觉 oddball（偏差刺激）任务中，Magliacano 等（2020）则观察到眨眼频率随认知负荷增加。不同感觉通道中的结果方向并不一致，说明眨眼与任务要求之间的关系具有情境依赖性。
