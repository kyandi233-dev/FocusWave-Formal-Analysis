...
- B 线继续判断持续性注意反应任务（SART，持续性注意反应任务）中的反应时、反应时变异、遗漏、误按、信号检测指标和思维探针分别具有何种构念含义；
- C–E 线继续判断瞳孔、眨眼、身体运动、心率和呼吸率分别与持续注意、警觉维持、心智游移、任务投入和唤醒存在什么关系以及哪些混杂需要控制；
- F 线继续判断“多种观测联合”在已有文献中是否真正提高测评效度和跨参与者泛化，而不是由本节的测量困难直接推出多模态一定更优；
- 六线完成后，再决定本节与后续 2.2–2.5 的最终概念分工，避免同一理论内容重复出现。
