...
第五章已压缩测量决策过程，正文保留参与者内主要关系及必要的参与者间伴随结论。全部 95 项正式效应（任务进程 15、注意内容 30、清醒等级 10、行为联系 40）从交接原始表逐行生成于 [眼部与预测完整结果附表](../附录/第5章-眼部与预测完整结果附表.md)，包含每项实际人数、场次和探针分母。此前指向 5.3.6—5.3.9 的表号由新正文与该附表接替，原始结果、分析族及角色不变。
